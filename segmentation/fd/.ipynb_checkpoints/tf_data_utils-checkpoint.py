...
def _construct_norm_arrays(file_path: str, metadata_path: str, fold: int = None, filesystem: S3FS = None) -> \
    ...
    """ Return arrays with normalization factors to be used """
    ...
    ### Each vector has all the normalization values to be used. However, this values are not different for each
    ### element. They are the same for each month. This was calculated on notebook 06.
